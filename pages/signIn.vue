...
<template>
    ...
    >
        <section aria-label="left-side" class="h-full hidden md:block">
            <div
                aria-label="image container"
                class="bg-muted/30 h-full w-full"
            ></div>
        </section>
        <section
            aria-label="right-side"
            class="h-full flex flex-col px-5 justify-center items-center"
        >
            <h1 class="mb-6 md:max-w-[350px] text-[2rem] font-[700]">Log In</h1>
            <Button
                variant="outline"
                @click="logWithGithub"
